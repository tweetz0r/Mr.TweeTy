...
const variableResolver_1 = require("./utilities/variableResolver");
/**
...
class ProjectTemplatesPlugin {
    ...
    getTemplates() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.createTemplatesDirIfNotExists();
            let templateDir = yield this.getTemplatesDir();
    ...
    getTemplatesDir() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resolver = new variableResolver_1.default();
            let rdir = yield resolver.resolve(dir);
    ...
    createTemplatesDirIfNotExists() {
        return __awaiter(this, void 0, void 0, function* () {
            let templatesDir = yield this.getTemplatesDir();
    ...
    chooseTemplate() {
        return __awaiter(this, void 0, void 0, function* () {
            // read templates
            let templates = yield this.getTemplates();
            let templateRoot = yield this.getTemplatesDir();
    ...
    saveAsTemplate(workspace) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield vscode.window.showInputBox(inputOptions).then((filename) => __awaiter(this, void 0, void 0, function* () {
                ...
                let templateDir = path.join(yield this.getTemplatesDir(), template);
...
//# sourceMappingURL=projectTemplatesPlugin.js.map